...
describe('Transcription AI API', () => {
  ...
  describe('Webhook Endpoint', () => {
    test('POST /api/v1/webhooks/zoom returns queued status with valid payload', async () => {
      const payload = {
    ...
    test('POST /api/v1/webhooks/zoom rejects invalid event type', async () => {
      const payload = {
        event: 'invalid_event',
        payload: {},
      };
    ...
    test('POST /api/v1/webhooks/zoom rejects invalid download URL', async () => {
      const payload = {
        event: 'recording.completed',
        payload: {
          object: {
    ...
    test('POST /api/v1/webhooks/zoom rejects empty recording files', async () => {
      const payload = {
        event: 'recording.completed',
        payload: {
          object: {
